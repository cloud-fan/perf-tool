@REM realtime-chart launcher script
@REM
@REM Envioronment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM REALTIME_CHART_config.txt found in the REALTIME_CHART_HOME.
@setlocal enabledelayedexpansion

@echo off
if "%REALTIME_CHART_HOME%"=="" set "REALTIME_CHART_HOME=%~dp0\\.."
set ERROR_CODE=0

set "APP_LIB_DIR=%REALTIME_CHART_HOME%\lib\"
...
set "CFG_FILE=%REALTIME_CHART_HOME%\REALTIME_CHART_config.txt"
set CFG_OPTS=
if exist %CFG_FILE% (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running realtime-chart.
  echo.
